...
const HUBS: Record<string, CountryHubContent> = {
  ...
  CH: {
    seoTitle: "İsviçre Gezi Rehberi: 8 Şehir, Tren ve Alp Rotaları",
    seoDescription: "İsviçre gezi rehberi: Zürih, Luzern, Bern, Cenevre, Lozan, Interlaken, Zermatt ve St. Moritz için vize, tren ve Alp rotaları.",
    planningHeading: "İsviçre rotası nasıl kurulur?", essentialsHeading: "İsviçre'ye gitmeden önce bilinmesi gerekenler", citiesHeading: "İsviçre'de gezilecek şehirler ve Alp rotaları",
    cityGridIntro: "İsviçre'de gezilecek yerler tek bir panoramik tren listesinden ibaret değildir. Zürih sanat ve göl yaşamını, Bern UNESCO başkent dokusunu, Luzern merkezi göl–dağ bağlantılarını açar. Cenevre ile Lozan Fransızca göl kıyısını; Interlaken Jungfrau bölgesini, Zermatt Matterhorn'u, St. Moritz ise Engadin ve Bernina hattını temsil eder. Kısa yolculukta bütün dağ merkezlerini toplamak yerine bir şehir omurgası ile tek Alp bölgesi seçin.",
    intro: ["İlk İsviçre yolculuğunda Zürih–Luzern–Bern hattını trenle bağlayıp Interlaken veya Zermatt'tan birini eklemek 9–12 gün için dengelidir. Cenevre–Lozan–Lavaux batıdaki Fransızca eksen; St. Moritz–Bernina ise ayrı doğu ayağıdır. Kapıdan kapıya süre kısa görünse bile otel değişimi, dağ treni ve hava yedeği gerçek gezi zamanını azaltır.", "SBB ülke çapında tren, otobüs ve birçok tekne bağlantısını güçlü biçimde birleştirir. Buna rağmen teleferik, özel dağ treni, panoramik vagon rezervasyonu ve şehir içi misafir kartının kapsamı farklı olabilir. Bir pass almadan önce gerçek rotanızdaki tek bilet, Half Fare Card ve pass toplamlarını karşılaştırın."],
    essentials: [
      { title: "Schengen vizesi gerekir; İsviçre AB üyesi değildir", body: "Umuma mahsus Türk pasaportuyla kısa turistik ziyaret için Schengen vizesi gerekir. İsviçre Schengen alanındadır ama Avrupa Birliği üyesi değildir. Ana destinasyon kuralıyla yetkili resmî başvuru merkezini kullanın; EES biyometrik giriş–çıkış kaydı tutar ve ETIAS vizenin yerine geçmez." },
      { title: "SBB bileti ile dağ işletmesini aynı sanmayın", body: "SBB çoğu kapıdan kapıya bağlantıyı gösterir; fakat Gornergrat, Jungfrau, Pilatus, Rigi, Corviglia veya Bernina panoramik vagonunda indirim, rezervasyon ve geçerlilik farklıdır. Son iniş, bakım ve hava durumunu ilgili işletmeden ayrıca kontrol edin." },
      { title: "İsviçre frangı kullanın ve dinamik kuru reddedin", body: "Kart yaygın, küçük dağ kulübesi ve kırsal otomat için az miktarda CHF yararlıdır. Avro kabul edilse bile kur ve para üstü elverişsiz olabilir. Kart terminalinde TL veya avro yerine CHF seçmek maliyeti daha görünür tutar." },
      { title: "Dağda görünürlük, irtifa ve kapanış biletin önündedir", body: "Şehirde açık hava zirvede sis, rüzgâr veya kar anlamına gelebilir. MeteoSwiss ve canlı işletme durumuna bakın; yüksek irtifada yavaş çıkın, uygun katman taşıyın ve kapalı patikaya girmeyin. Kurtarma ve dağ faaliyeti kapsamını sigortadan doğrulayın." },
      { title: "Dört dil bölgesinde yerel istasyon adını kaydedin", body: "Almanca, Fransızca, İtalyanca ve Romanşça bölgeye göre değişir. İngilizce yaygın olsa da istasyon, dağ hattı ve son otobüs duyurusu yerel dilde olabilir. Bilet ekranı, otel adresi ve durak adını çevrimdışı saklayın." },
    ],
    routeIdeas: [
      { title: "İlk İsviçre gezisi", duration: "9–12 gün", cities: ["Zürih", "Luzern", "Bern", "Interlaken"], description: "Zürih iki-üç, Luzern iki, Bern iki ve Interlaken üç-dört gece; SBB ağıyla araçsız klasik omurga." },
      { title: "Fransızca göl kıyısı", duration: "5–7 gün", cities: ["Cenevre", "Lozan"], description: "Cenevre'de iki-üç, Lozan'da iki-üç gece; Lavaux, Vevey ve Montreux'u trenle ekleyin." },
      { title: "Matterhorn derin rota", duration: "4–6 gün", cities: ["Zermatt"], description: "Hava yedeği bırakarak Gornergrat, Sunnegga ve köy günlerini ayırın; Zermatt'ı Interlaken'den acele günübirlik yapmayın." },
      { title: "Engadin ve Bernina", duration: "5–8 gün", cities: ["St. Moritz"], description: "St. Moritz veya Pontresina üssünden göller, Morteratsch ve Bernina–Tirano hattı; panoramik rezervasyon ile normal treni karşılaştırın." },
    ],
  },
  BE: {
    seoTitle: "Belçika Gezi Rehberi: 8 Şehir, Tren ve Kültür Rotası",
    seoDescription: "Belçika gezi rehberi: Brüksel, Brugge, Gent, Anvers, Leuven, Liège, Dinant ve Ardenler için vize, tren, müze ve rota planı.",
    planningHeading: "Belçika rotası nasıl kurulur?", essentialsHeading: "Belçika'ya gitmeden önce bilinmesi gerekenler", citiesHeading: "Belçika'da gezilecek şehirler ve doğa rotaları",
    cityGridIntro: "Belçika'da gezilecek şehirler kısa tren mesafelerine rağmen birbirinin kopyası değildir. Brüksel çok dilli başkent ve Art Nouveau merkezi; Brugge ile Gent Flaman sanat ve kanal tarihini farklı ritimlerde sunar. Anvers liman, moda ve Rubens; Leuven üniversite kültürüyle öne çıkar. Fransızca konuşulan Liège ile Dinant Meuse vadisini, Ardenler ise kale, orman ve küçük kasabaları açar. Her gün otel değiştirmek yerine Brüksel/Gent ve bir Valonya üssü kurun.",
    intro: ["İlk Belçika gezisinde Brüksel'e üç, Gent veya Brugge'ye iki-üç gece ayırın; Anvers ve Leuven sık trenle eklenebilir. Bu yakınlık bütün şehirleri aynı gün görmek anlamına gelmez: müze, çan kulesi, kanal ve akşam ışığı her şehirde ayrı zaman ister.", "Valonya rotasında Liège veya Namur ulaşım üssü; Dinant ve Ardenler doğa–kale ayağıdır. Ardenler tek nokta değildir: Durbuy, La Roche, Bouillon ve Hautes Fagnes farklı yönlerde yer alır. Toplu taşıma seyrekleştiği için bir alt bölge seçin ve son bağlantıyı önceden kaydedin."],
    essentials: [
      { title: "Schengen başvurusunu yalnız yetkili kanaldan yapın", body: "Umuma mahsus Türk pasaportuyla kısa turistik ziyaret için Schengen vizesi gerekir. Belçika başvurusu ana destinasyon kuralıyla yetkili resmî dış hizmet sağlayıcısından yapılır. Aracı site randevu olasılığını veya onay şansını artırmaz; EES kaydı ve pasaport koşulunu resmî kaynaktan izleyin." },
      { title: "SNCB/NMBS ile şehir içi işletmeleri ayırın", body: "Ulusal tren SNCB/NMBS; Brüksel STIB/MIVB, Flandre De Lijn, Valonya TEC kullanır. Bir şehir bileti bütün ülkede geçmez. Bruxelles-Midi/Brussel-Zuid gibi iki dilli istasyon adını ve doğru garı bilet ekranından kontrol edin." },
      { title: "Üç resmî dil coğrafyanın parçasıdır", body: "Flandre'da Felemenkçe, Valonya'da Fransızca, doğuda Almanca; Brüksel'de Fransızca ve Felemenkçe resmîdir. Şehirlerin iki adı olabilir. Yerel adı kullanmak tabela ve aktarmayı kolaylaştırır; bölgesel kimlikleri tek bir dil altında genellemeyin." },
      { title: "Bira, çikolata ve waffle kalite kadar ölçü meselesidir", body: "Bira dereceleri beklenenden yüksek olabilir; tadım sonrası araç veya bisiklet kullanmayın. Trappist, manastır ve zanaat etiketi aynı şeyi garanti etmez. Çikolatada üretici, kakao oranı, dolgu ve alerjeni; waffle'da Brüksel–Liège farkını sorun." },
      { title: "Ardenler'de şehir konforu hızla biter", body: "Otobüs, kapsama ve restoran saatleri seyrek olabilir. Çevrimdışı harita, su, yağmurluk ve dönüş planı taşıyın. Sel, av, yangın veya buz nedeniyle kapalı patikaya girmeyin; kaya ve nehir etkinliğinde lisanslı işletme seçin." },
    ],
    routeIdeas: [
      { title: "İlk Belçika şehirleri", duration: "7–9 gün", cities: ["Brüksel", "Gent", "Brugge"], description: "Brüksel üç, Gent iki, Brugge iki gece; kısa trenlerle ama akşam atmosferlerini koruyan rota." },
      { title: "Flaman sanat ve tasarım", duration: "6–8 gün", cities: ["Anvers", "Leuven", "Gent"], description: "Rubens ve moda, üniversite mirası, Ghent Altarpiece; trenle iki üs yeterlidir." },
      { title: "Meuse ve Valonya", duration: "5–7 gün", cities: ["Liège", "Dinant"], description: "Liège'de iki-üç, Dinant'ta bir-iki gece; Namur veya Spa'yı ilgiye göre ekleyin." },
      { title: "Ardenler yavaş rotası", duration: "4–7 gün", cities: ["Ardenler"], description: "Durbuy–La Roche veya Bouillon–Semois alt bölgelerinden birini seçin; bütün Ardenler'i tek hafta sonunda dolaşmayın." },
    ],
  },
  HU: {
    seoTitle: "Macaristan Gezi Rehberi: 8 Şehir, Termal ve Göl Rotaları",
    seoDescription: "Macaristan gezi rehberi: Budapeşte, Szentendre, Eger, Pécs, Szeged, Debrecen, Balaton ve Sopron için vize, tren ve rota planı.",
    planningHeading: "Macaristan rotası nasıl kurulur?", essentialsHeading: "Macaristan'a gitmeden önce bilinmesi gerekenler", citiesHeading: "Macaristan'da gezilecek şehirler ve bölgesel rotalar",
    cityGridIntro: "Macaristan'da gezilecek yerler Budapeşte'nin Tuna ve termal hamamlarından çok daha geniştir. Szentendre sanat ve Sırp mirası; Eger kale, Osmanlı izi ve bağlar; Pécs Roma–Osmanlı–Zsolnay katmanları sunar. Szeged Tisza ve Art Nouveau, Debrecen Reform geleneği ile Hortobágy kapısıdır. Balaton Gölü kuzey kıyı bağları ve kasabaları, Sopron ise Roma–Orta Çağ merkezi ile Fertő sınır peyzajını birleştirir.",
    intro: ["İlk yolculukta Budapeşte'ye dört-beş gece ayırın; Szentendre'yi günübirlik, Eger'i en az iki gece ekleyin. Pécs, Szeged ve Debrecen başkentten üç ayrı yöndedir; üçünü kısa rotada yıldız biçiminde gezmek yerine güney veya doğu hattı seçin.", "Balaton tek kasaba değil, 78 kilometrelik göl bölgesidir. Balatonfüred–Tihany ilk kuzey üssü; Badacsony bağ–volkan, Keszthely–Hévíz batı kültür/termal ayağıdır. Sopron batıda Viyana ve Fertő Gölü ile doğal devam verir; uluslararası sınır geçişinde belge ve bilet koşulunu kontrol edin."],
    essentials: [
      { title: "Schengen vizesi için yetkili Macaristan kanalını kullanın", body: "Umuma mahsus Türk pasaportuyla kısa turistik ziyaret için Schengen vizesi gerekir. Başvuru, ana destinasyon kuralıyla Macaristan'ın yetkilendirdiği resmî dış hizmet sağlayıcısı üzerinden yürür. EES biyometrik giriş–çıkış kaydı tutar; ETIAS vizenin yerine geçmez." },
      { title: "Forint kullanın, avro tabelasına aldanmayın", body: "Macar forinti resmî paradır. Kart yaygın olsa da pazar ve kırsalda nakit gerekir. Avro fiyatı zayıf kurla çevrilebilir; banka ATM'si kullanın, gizli komisyonu okuyun ve terminalde HUF seçin. Döviz bürosunda alış–satış farkını işlemden önce görün." },
      { title: "MÁV ile BKK aynı bilet sistemi değildir", body: "MÁV ülke treni ve birçok bölgesel otobüsü, BKK/BudapestGO başkent ulaşımını yönetir. HÉV şehir sınırı, havaalanı otobüsü ve hızlı/ek hizmetler farklı bilet isteyebilir. Belgenizi çevrimdışı saklayın ve peron değişikliğini canlı kaynaktan kontrol edin." },
      { title: "Termal hamam seçimini sağlık ve kuralla yapın", body: "Her hamamın havuz sıcaklığı, çocuk, mayo, bone, karma gün ve tedavi hizmeti farklıdır. Uzun süre sıcak suda kalmayın; kalp/dolaşım sorununuzda doktor önerisi alın. Bileti resmî siteden alıp dolap/kabin dahilini okuyun." },
      { title: "Balaton ve Puszta'da mevsim günlük planı değiştirir", body: "Balaton'da fırtına ışığı ve son feribot, Hortobágy'da açık arazi sıcağı ile koruma kuralı belirleyicidir. Bağda tadım sonrası araç/bisiklet kullanmayın; işaretli parkur ve resmî ziyaret merkezi dışına çıkmayın." },
    ],
    routeIdeas: [
      { title: "İlk Macaristan yolculuğu", duration: "7–9 gün", cities: ["Budapeşte", "Szentendre", "Eger"], description: "Budapeşte beş, Szentendre bir tam gün, Eger iki gece; Tuna, termal, kale ve bağ dengesi." },
      { title: "Güney kültür şehirleri", duration: "6–8 gün", cities: ["Pécs", "Szeged"], description: "Pécs'te Roma–Osmanlı–Zsolnay, Szeged'de Art Nouveau–Tisza; Budapeşte üzerinden tren bağlantılı iki ayrı üs." },
      { title: "Balaton ve batı sınırı", duration: "8–11 gün", cities: ["Balaton Gölü", "Sopron"], description: "Balatonfüred/Tihany ve Keszthely'de iki üs, ardından Sopron–Fertő; yazın son tren ve feribotu erken kontrol edin." },
      { title: "Doğu ve Puszta", duration: "4–6 gün", cities: ["Debrecen"], description: "Debrecen'de iki-üç gece ve resmî rehberli Hortobágy günü; açık araziyi acele günübirlik fotoğraf turuna indirmeyin." },
    ],
  },
  CZ: {
    seoTitle: "Çek Cumhuriyeti Gezi Rehberi: 8 Şehir ve Rota Planı",
    seoDescription: "Çek Cumhuriyeti gezi rehberi: Prag, Český Krumlov, Brno, Karlovy Vary, Kutná Hora, Olomouc, Plzeň ve Bohemya İsviçresi.",
    planningHeading: "Çek Cumhuriyeti rotası nasıl kurulur?", essentialsHeading: "Çek Cumhuriyeti'ne gitmeden önce bilinmesi gerekenler", citiesHeading: "Çek Cumhuriyeti'nde gezilecek şehirler ve doğa rotaları",
    cityGridIntro: "Çek Cumhuriyeti'nde gezilecek yerler Prag'ın kulelerinden çok daha geniştir. Český Krumlov Güney Bohemya'nın kale–nehir peyzajını, Brno modern mimari ile Moravya bağlarını, Karlovy Vary kaplıca mirasını açar. Kutná Hora gümüş ve Gotik tarihi, Olomouc Barok–üniversite kimliği, Plzeň sanayi ve bira kültürü sunar. Bohemya İsviçresi ise kanyon ve kumtaşı parkurlarıyla şehir rotasına güçlü bir doğa ayağı ekler.",
    intro: ["İlk yolculukta Prag'a dört-beş gece ayırıp trenle Kutná Hora'yı ekleyin; ardından Český Krumlov veya Brno'dan birinde iki-üç gece kalın. Karlovy Vary ile Plzeň batı, Olomouc ile Brno doğu eksenindedir. Bütün ülkeyi Prag'dan günübirlik yıldız rota halinde tüketmek yerine iki üs kurun.", "Ülke içi tren güçlüdür ama České dráhy, RegioJet ve Leo Express'in biletleri her zaman birbirinin seferinde geçmez. Bohemya İsviçresi, kale ve spa günlerinde son otobüs ile sezon kapanışı belirleyicidir. Her rota için kapıdan kapıya süreyi ve dönüş yedeğini kullanın."],
    essentials: [
      { title: "Umuma mahsus Türk pasaportuna Schengen vizesi gerekir", body: "Çekya'nın Ankara Büyükelçiliği Türk vatandaşlarının kısa ve uzun kalış için vizeye tabi olduğunu, yeşil pasaport sahiplerinin kısa ve kazanç amacı taşımayan ziyaretlerde muaf olabildiğini belirtiyor. Başvuruyu ana destinasyon kuralıyla yalnız yetkili vize merkezinden yapın; kişisel pasaport koşulunu güncel resmî kaynaktan teyit edin." },
      { title: "Avro değil Çek korunası kullanılır", body: "Kart yaygın olsa da pazar ve küçük kasabada CZK nakit yararlıdır. Avro kabulü iyi kur anlamına gelmez. Bağımsız ATM ve döviz bürosunda toplam komisyonu görün, dinamik kur dönüşümünü reddedip terminalde CZK seçin." },
      { title: "Operatör ve bilet kapsamını kontrol edin", body: "České dráhy ülke ağının temelidir; özel trenler ve şehir ulaşımı ayrı ürünler kullanır. Prag bileti ülke trenine, bir demiryolu işletmesinin bileti diğerine otomatik geçmeyebilir. Doğru istasyon adını ve son bağlantıyı çevrimdışı saklayın." },
      { title: "Spa, bira ve bağ deneyiminde sağlık/ulaşım planı yapın", body: "Kaplıca suyunu tıbbi tedavi gibi kullanmadan önce doktorunuza danışın. Bira fabrikası ve Moravya bağ tadımı sonrası araç veya bisiklet kullanmayın. Turun ölçü, yaş, dil ve dönüş koşulunu rezervasyonda okuyun." },
      { title: "Milli parkın günlük kapanışı rotadan üstündür", body: "Bohemya İsviçresi'nde yangın, kaya düşmesi, taşkın veya bakım kanyon ve patikaları kapatabilir. Eski blog rotasına değil parkın güncel duyurusuna uyun; ateş yakmayın ve kapalı bölgeye girmeyin." },
    ],
    routeIdeas: [
      { title: "İlk Çekya yolculuğu", duration: "8–10 gün", cities: ["Prag", "Kutná Hora", "Český Krumlov"], description: "Prag beş, Krumlov iki gece; Kutná Hora'yı trenle tam gün ve doğru istasyon planıyla ekleyin." },
      { title: "Moravya kültür rotası", duration: "6–8 gün", cities: ["Brno", "Olomouc"], description: "Brno üç-dört, Olomouc iki-üç gece; Mikulov veya Moravya Karstı'nı tek ek gün olarak seçin." },
      { title: "Batı Bohemya", duration: "5–7 gün", cities: ["Plzeň", "Karlovy Vary"], description: "Plzeň'de sanayi ve mimari, Karlovy Vary'de spa ve orman; iki ayrı üs ve tren/otobüs bağlantısı." },
      { title: "Kumtaşı doğa ayağı", duration: "4–6 gün", cities: ["Bohemya İsviçresi"], description: "Děčín/Hřensko veya Jetřichovice alt bölgesini seçin; park kapanışı ve kötü hava için şehir yedeği bırakın." },
    ],
  },
  PL: {
    seoTitle: "Polonya Gezi Rehberi: 8 Şehir, Tatra ve Baltık Rotaları",
    seoDescription: "Polonya gezi rehberi: Varşova, Kraków, Gdańsk, Wrocław, Poznań, Zakopane, Toruń ve Lublin için vize, tren ve rota planı.",
    planningHeading: "Polonya rotası nasıl kurulur?", essentialsHeading: "Polonya'ya gitmeden önce bilinmesi gerekenler", citiesHeading: "Polonya'da gezilecek şehirler ve doğa rotaları",
    cityGridIntro: "Polonya'da gezilecek yerler ülkenin savaş hafızası kadar canlı bugünü ve bölgesel çeşitliliğini de gösterir. Varşova yeniden inşa ile çağdaş metropolü; Kraków kraliyet ve Yahudi mirasını; Gdańsk Baltık ile Dayanışma tarihini açar. Wrocław Silezya adaları, Poznań Büyük Polonya'nın erken tarihi, Toruń tuğla Gotik ve Kopernik, Lublin ise çok kültürlü doğu rotasıdır. Zakopane, şehir haftasını Tatra'nın ciddi dağ koşullarıyla dengeler.",
    intro: ["İlk rota için Varşova–Kraków arasında hızlı tren kullanıp her birine dört-beş gece ayırın. Gdańsk'ı üçüncü şehir olarak eklemek 12–15 günlük güçlü bir omurga verir. Wrocław ve Poznań batı, Lublin doğu yönündedir; kısa tatilde ikisini aynı hatta toplamayın.", "Toruń, Gdańsk–Poznań veya Varşova arasında bir-iki geceyle eklenebilir. Zakopane ise Kraków'dan günübirlik kalabalık transfer yerine dört gecelik hava yedekli dağ üssü olarak daha anlamlıdır. Auschwitz-Birkenau, Majdanek ve savaş müzelerini eğlence durağı değil anma/öğrenme alanı olarak planlayın."],
    essentials: [
      { title: "Schengen vizesi ve ana destinasyon kuralı", body: "Umuma mahsus Türk pasaportuyla kısa turistik ziyaret için Schengen vizesi gerekir. Polonya temsilciliği C tipi vizeyi 180 günde en fazla 90 günlük çerçevede tanımlar; başvuru Polonya tek veya ana destinasyon olduğunda yapılır. Yalnız resmî temsilcilik ve yetkili VFS kanalını kullanın." },
      { title: "Zlotiyle ödeme yapın", body: "Kart çok yaygındır; yine de dağ kulübesi, pazar ve küçük kırsal bağlantı için biraz PLN gerekir. ATM ücretini okuyun, banka makinesini tercih edin ve kart terminalinde TL/avro değil PLN seçin." },
      { title: "PKP Intercity ile bölgesel işletmeleri ayırın", body: "Uzun mesafede PKP Intercity temel kaynak; bölgesel hatlarda farklı şirketler çalışır. Tren numarası, istasyon, vagon ve biletin hangi işletmede geçerli olduğunu kontrol edin. Şehir uygulamasındaki rota önerisini bilet geçerliliği sanmayın." },
      { title: "Hafıza mekânlarında davranış rotanın parçasıdır", body: "Auschwitz-Birkenau, Majdanek, getto ve savaş anıtlarında sessiz, bağlama uygun ve resmî kurallara bağlı davranın. İnsan kaybını selfie dekoruna çevirmeyin; kapsamlı ziyaretlerin arasına zihinsel dinlenme payı koyun." },
      { title: "Tatra'da park ve kurtarma duyurusu belirleyicidir", body: "TOPR ve Tatra Milli Parkı hava, fırtına, çığ, ayı veya patika kapanışı yayımlayabilir. Kapalı rotaya girmeyin; doğru ayakkabı, katman ve su taşıyın. Dağ kurtarma kapsamını sigortanızdan doğrulayın." },
    ],
    routeIdeas: [
      { title: "İlk Polonya şehirleri", duration: "10–13 gün", cities: ["Varşova", "Kraków"], description: "Her şehre dört-beş gece; bir hafıza müzesi, bir mahalle ve bir yavaş gün ritmi." },
      { title: "Baltık ve Gotik rota", duration: "7–10 gün", cities: ["Gdańsk", "Toruń"], description: "Gdańsk dört, Toruń iki gece; Sopot/Gdynia veya Malbork'tan yalnız birini ekleyin." },
      { title: "Batı Polonya şehirleri", duration: "7–9 gün", cities: ["Wrocław", "Poznań"], description: "Wrocław dört, Poznań üç gece; Książ/Świdnica ya da Gniezno'yu ilgiye göre seçin." },
      { title: "Dağ ve doğu kültürü", duration: "9–12 gün", cities: ["Zakopane", "Lublin"], description: "Birbirinden uzak iki ayrı ayak; Kraków/Varşova üzerinden ulaşım ve her biri için en az dört gece." },
    ],
  },
  RU: {
    seoTitle: "Rusya Gezi Rehberi: 8 Bölge, Vize ve Kıta Rotaları",
    seoDescription: "Rusya gezi rehberi: Moskova, St. Petersburg, Kazan, Soçi, Kaliningrad, Murmansk, Baykal ve Vladivostok için vize ve rota.",
    planningHeading: "Rusya rotası nasıl kurulur?", essentialsHeading: "Rusya'ya gitmeden önce bilinmesi gerekenler", citiesHeading: "Rusya'da gezilecek şehirler ve doğa rotaları",
    cityGridIntro: "Rusya'da gezilecek yerler aynı kısa seyahatte toplanabilecek bir şehir listesi değildir. Moskova büyük müze ve başkent ölçeğini, St. Petersburg saraylar ile kanalları, Kazan Tatar–Volga kültürünü açar. Soçi Karadeniz ve Kafkasları, Kaliningrad Baltık eksklavını, Murmansk Arktik koşulları temsil eder. Baykal ile Vladivostok ise Moskova'dan saat dilimleri ve binlerce kilometre uzakta, ayrı uçuş veya uzun demiryolu yolculukları isteyen Sibirya–Pasifik rotalarıdır.",
    intro: ["İlk yolculukta Moskova'ya beş-altı, St. Petersburg'a beş-altı gece ayırmak ve aradaki hızlı/gece trenini güncel RZD kaynağından almak dengelidir. Kazan bu hatta üç-dört gecelik ayrı tren/uçuş ayağı olabilir. Soçi, Kaliningrad ve Murmansk'ı aynı kısa geziye eklemeyin; her biri farklı coğrafya ve mevsimdir.", "Baykal için Irkutsk üzerinden en az yedi-on gün, Vladivostok için dört-altı gün ve ayrı ulaşım gerekir. Trans-Sibirya bir şehirler arası tren bileti değil, birden fazla gün ve saat diliminden geçen ciddi lojistik karardır. Vize, ödeme, sigorta, bağlantı, sefer ve güvenlik koşullarını rezervasyonla birlikte yeniden doğrulayın."],
    essentials: [
      { title: "Önce güncel seyahat uyarısını değerlendirin", body: "Rusya'daki güvenlik ve ulaşım durumu kısa sürede değişebilir. Birleşik Krallık FCDO 21 Ağustos 2026 itibarıyla savaş, güvenlik olayları, uçuş kesintileri ve sınırlı konsolosluk desteği nedeniyle tüm seyahatlere karşı uyarıyor. Bu yabancı uyarı Türk vatandaşına bağlayıcı değildir; T.C. Dışişleri, Türkiye'nin Moskova Büyükelçiliği, sigortacı ve taşıyıcınızın güncel bilgisini karar öncesi birlikte kontrol edin." },
      { title: "Türkiye birleşik e-vizeye uygun; koşulları eksiksiz okuyun", body: "Rusya Dışişleri'nin güncel sisteminde Türkiye uygun ülke listesinde. Birleşik e-vize tek girişli, düzenlenmesinden itibaren 120 gün geçerli ve girişten itibaren en fazla 30 gün kalış sağlar; başvuru 86 gün ile en geç 4 gün önce yapılabilir. Yalnız belirtilen sınır noktaları, en az altı ay geçerli makine okunur pasaport ve geçerli sağlık sigortası gibi şartları resmî sayfadan kontrol edin." },
      { title: "Seyahat amacı ile vize türü birebir uyuşmalıdır", body: "T.C. Dışişleri, sınırda seyahat amacıyla çelişen açıklama ve belgenin geri çevrilmeye yol açabileceğini vurguluyor. Otel, dönüş ve geçim belgelerini taşıyın; çalışma, eğitim veya başka amaç için turistik vize/e-vize kullanmayın." },
      { title: "Yabancı kartın çalışacağını varsaymayın", body: "Kart, ATM ve çevrimiçi ödeme erişimi hızlı değişebilir. Kendi bankanız ve kart ağınızdan seyahat öncesi yazılı teyit alın; yalnız yasal döviz/ödeme kanallarını kullanın ve gümrükte nakit beyan sınırını doğrulayın. Tek ödeme yöntemine güvenmeyin." },
      { title: "Uygulama, internet ve ulaşımı çevrimdışı yedekleyin", body: "Roaming, eSIM, harita ve uluslararası uygulama erişimi değişebilir. RZD, havalimanı ve işletmenin resmî kanalını kullanın; bilet, otel, sigorta ve Rusça adresleri çevrimdışı saklayın. Saat dilimini her uzun bağlantıda yeniden kontrol edin." },
      { title: "Güvenlik ve özel bölge kurallarına uyun", body: "Gösteri ve siyasi kalabalıklardan uzak durun; askerî, sınır, liman ve kritik altyapıyı fotoğraflamayın. Kaliningrad, Kola, kıyı ve sınır rotalarında özel izin/kontrol olabilir. Güncel seyahat duyurusunu T.C. Dışişleri ve yetkili Rus makamlarından izleyin." },
      { title: "Doğa rotasında lisanslı yerel operasyon kullanın", body: "Baykal buzuna resmî güvenlik olmadan çıkmayın; Murmansk tundrası, Soçi dağları ve Primorye kıyısında hava/kapanış talimatına uyun. Çığ, buz, tayfun, yangın ve yaban hayatı riskini sıradan şehir gezisi gibi değerlendirmeyin." },
    ],
    routeIdeas: [
      { title: "İlk Rusya şehir rotası", duration: "12–16 gün", cities: ["Moskova", "St. Petersburg"], description: "Her şehre beş-altı gece, arada güncel hızlı/gece treni; saray ve müzeleri ayrı günlere bölün." },
      { title: "Volga kültür ayağı", duration: "4–6 gün", cities: ["Kazan"], description: "Kremlin, Tatar mahallesi ve Sviyazhsk/Bolgar'dan yalnız birini ekleyerek derin rota." },
      { title: "Kuzey ve Baltık", duration: "8–12 gün", cities: ["Murmansk", "Kaliningrad"], description: "Birbirine yakın değildir; iki ayrı uçuş ve farklı mevsim planı gerektirir. Kısa geziyse yalnız birini seçin." },
      { title: "Sibirya–Pasifik", duration: "14–20 gün", cities: ["Baykal Gölü", "Vladivostok"], description: "Irkutsk/Baykal en az sekiz, Vladivostok beş gece; uçuş veya çok günlük demiryolu için saat dilimi ve yedek gün." },
      { title: "Karadeniz ve Kafkas", duration: "6–8 gün", cities: ["Soçi"], description: "Merkez kıyı, Sirius/Adler ve Krasnaya Polyana'yı üç ayrı gün kümesine bölün; sınır rotası eklemeyin." },
    ],
  },
  RS: {
    seoTitle: "Sırbistan Gezi Rehberi: 8 Şehir, Tuna ve Dağ Rotaları",
    seoDescription: "Sırbistan gezi rehberi: Belgrad, Novi Sad, Niş, Subotica, Zlatibor, Tara, Kopaonik ve Demir Kapı için ulaşım, bütçe ve rota planı.",
    planningHeading: "Sırbistan rotası nasıl kurulur?", essentialsHeading: "Sırbistan'a gitmeden önce bilinmesi gerekenler", citiesHeading: "Sırbistan'da gezilecek şehirler ve doğa rotaları",
    cityGridIntro: "Sırbistan'da gezilecek yerler Belgrad'ın nehir kıyılarından çok daha geniştir. Novi Sad ve Subotica çok kültürlü Vojvodina'yı, Niş Roma–Osmanlı–yakın tarih katmanlarını açar. Zlatibor ve Kopaonik dört mevsim dağ merkezleri; Tara sık orman ve Drina, Demir Kapı ise Tuna kanyonu ile tarih öncesi ve Roma mirası için ayrı doğa rotalarıdır.",
    intro: ["İlk yolculukta Belgrad'a dört gece, hızlı trenle Novi Sad'a iki gece ayırın; Subotica'yı kuzey hattına ekleyin. Niş güneydoğu yönünde ayrı tren/otobüs ayağıdır ve Roma mirasıyla en az iki geceyi hak eder.", "Zlatibor–Tara batıda doğal bir ikili olsa da araç/transfer gerekir. Kopaonik güneyde, Demir Kapı doğudadır; dört doğa bölgesini tek haftaya sıkıştırmayın. Park kapanışı, yol ve hava planını rezervasyondan sonra yeniden kontrol edin."],
    essentials: [
      { title: "Türk vatandaşları 90 güne kadar vizeden muaftır", body: "Sırbistan Dışişleri, umuma mahsus ve resmî Türk pasaportlarına altı aylık dönem içinde 90 güne kadar vize muafiyeti bildiriyor. Pasaport, dönüş, konaklama ve sınır koşullarını seyahatten hemen önce resmî kaynaktan yeniden doğrulayın." },
      { title: "Dinar ve kartı birlikte kullanın", body: "Sırp dinarı resmî paradır. Şehirde kart yaygın, pazar, küçük lokanta ve kırsalda nakit gerekir. Banka ATM'si kullanın, terminalde RSD seçin ve dinamik kur dönüşümünü reddedin." },
      { title: "Tren garı adını biletten okuyun", body: "Belgrad–Novi Sad hızlı tren güçlüdür; Belgrad Centar/Prokop ile eski garı karıştırmayın. Bölgesel hatta otobüs daha sık olabilir. Operatör, peron ve son dönüşü resmî kanaldan doğrulayın." },
      { title: "Konaklama kaydı ve sigortayı kontrol edin", body: "Otel/ev sahibi yabancı misafir kaydını yürütmelidir; belgenin tamamlandığını sorun. Dağ yürüyüşü, kayak, rafting ve tekne için faaliyet kapsamlı sağlık/kurtarma sigortası taşıyın." },
      { title: "Tarih ve sınır konularında hassas davranın", body: "1990'lar savaşları, Kosova ve anma alanlarını basitleştirmeyin; gösterilerden uzak durun. Bosna-Hersek, Karadağ, Romanya veya Macaristan'a geçiş ayrı sınır işlemidir; gerekli belgeyi önceden doğrulayın." },
    ],
    routeIdeas: [
      { title: "İlk Sırbistan şehirleri", duration: "7–9 gün", cities: ["Belgrad", "Novi Sad"], description: "Belgrad dört-beş, Novi Sad iki-üç gece; Sremski Karlovci'yi kuzey ayağına ekleyin." },
      { title: "Vojvodina ve güney", duration: "7–10 gün", cities: ["Subotica", "Niş"], description: "Birbirine yakın olmayan iki ayrı tren/otobüs ayağı; her birine iki-üç gece ve Belgrad ara bağlantısı." },
      { title: "Batı Sırbistan doğası", duration: "7–10 gün", cities: ["Zlatibor", "Tara Milli Parkı"], description: "İki üs, araç/transfer ve hava yedeği; Uvac veya Mokra Gora'dan yalnız birini ekleyin." },
      { title: "Zirve ve Tuna", duration: "8–12 gün", cities: ["Kopaonik", "Demir Kapı"], description: "Karşı yönlerde iki ayrı doğa rotası; kısa geziyse mevsime göre yalnız birini seçin." },
    ],
  },
  ME: {
    seoTitle: "Karadağ Gezi Rehberi: 8 Durak, Kotor ve Durmitor Rotaları",
    seoDescription: "Karadağ gezi rehberi: Kotor, Budva, Podgorica, Cetinje, Perast, Herceg Novi, Durmitor ve Ulcinj için güncel vize ve rota planı.",
    planningHeading: "Karadağ rotası nasıl kurulur?", essentialsHeading: "Karadağ'a gitmeden önce bilinmesi gerekenler", citiesHeading: "Karadağ'da gezilecek şehirler ve doğa rotaları",
    cityGridIntro: "Karadağ'da gezilecek yerler küçük haritada yoğunlaşsa da dağ ve kıyı yolları süreyi uzatır. Kotor, Perast ve Herceg Novi körfezin farklı yüzlerini; Budva tatil kıyısını, Ulcinj uzun plajlar ile Arnavut kültürünü açar. Cetinje tarihî başkent, Podgorica ulaşım merkezi; Durmitor ise Žabljak, buzul gölleri ve Tara Kanyonu için ayrı yüksek dağ ayağıdır.",
    intro: ["Kotor'da üç, Perast veya Herceg Novi'de iki, Budva'da iki geceyle körfez–Adriyatik hattı kurulabilir. Kruvaziyer ve yaz trafiği kısa mesafeyi saatlere çıkarabildiği için tek günde çok durak planlamayın.", "Durmitor'a Žabljak üzerinden en az dört gece ayırın. Podgorica ile Cetinje iç kesim bağlantısı, Ulcinj ise güney kıyı ayağıdır. Kuzey dağını kıyı uçuş gününe bağlamayın; hava ve yol yedeği bırakın."],
    essentials: [
      { title: "2026'da vize kuralı değişiyor", body: "Karadağ hükümetinin güncel kararına göre Türk vatandaşlarının vizesiz kalışı 30 gündür; 1 Kasım 2026'dan itibaren Türk vatandaşları için vize zorunluluğu başlayacaktır. Seyahat tarihinize göre resmî Karadağ kaynağını ve temsilciliği mutlaka yeniden kontrol edin." },
      { title: "Konaklama kaydı ve şehir vergisini tamamlayın", body: "Otel genellikle kaydı yapar; ev/pansiyonda süreci ve turist vergisi makbuzunu sorun. Sınırda veya çıkışta gerekebileceği için kayıt kanıtını saklayın." },
      { title: "Avro kullanılır; yaz fiyatını önceden görün", body: "Karadağ avro kullanır. Kart yaygın olsa da otobüs, küçük işletme ve dağda nakit gerekir. Plaj seti, otopark, tekne ve restoranda toplam fiyatı hizmetten önce netleştirin." },
      { title: "Kıyı yolu mesafeden daha uzun sürer", body: "Kotor–Budva ve körfez hattı yazın sıkışır; uçuş/feribot gününde geniş pay bırakın. Resmî otobüs terminali, araç sigortası, park ve sınır kuyruğunu birlikte hesaplayın." },
      { title: "Dağ ve denizde lisanslı hizmet kullanın", body: "Durmitor yürüyüşü, Tara raftingi ve körfez teknesinde hava, lisans, can yeleği/kask ve sigorta kapsamını doğrulayın. Bayrak, park kapanışı ve koruma kuralına uyun." },
    ],
    routeIdeas: [
      { title: "Kotor Körfezi", duration: "7–9 gün", cities: ["Kotor", "Perast", "Herceg Novi"], description: "Kotor üç-dört, diğer kıyılarda iki-üç gece; aynı dar yolda her gün üs değiştirmeyin." },
      { title: "Adriyatik kıyısı", duration: "7–10 gün", cities: ["Budva", "Ulcinj"], description: "Budva'da eski şehir ve koylar, Ulcinj'de uzun plaj ile delta; iki ayrı konaklama üssü." },
      { title: "Tarihî başkent ve yeni merkez", duration: "3–5 gün", cities: ["Podgorica", "Cetinje"], description: "Podgorica ulaşım, Cetinje müze ve Lovćen için; ikisine aynı kısa gün muamelesi yapmayın." },
      { title: "Durmitor doğası", duration: "5–7 gün", cities: ["Durmitor"], description: "Žabljak üssünde göl, bir orta yürüyüş ve lisanslı kanyon günü; zirve için hava yedeği." },
    ],
  },
  BA: {
    seoTitle: "Bosna-Hersek Gezi Rehberi: 8 Şehir, Köprü ve Doğa Rotaları",
    seoDescription: "Bosna-Hersek gezi rehberi: Saraybosna, Mostar, Blagaj, Travnik, Jajce, Banja Luka, Trebinje ve Una için ulaşım ve rotalar.",
    planningHeading: "Bosna-Hersek rotası nasıl kurulur?", essentialsHeading: "Bosna-Hersek'e gitmeden önce bilinmesi gerekenler", citiesHeading: "Bosna-Hersek'te gezilecek şehirler ve doğa rotaları",
    cityGridIntro: "Bosna-Hersek'te gezilecek yerler Saraybosna ve Mostar'ın ötesine uzanır. Blagaj Hersek karstını, Travnik Osmanlı idaresi ve edebiyatı, Jajce şelale ile Yugoslavya tarihini açar. Banja Luka Vrbas ve Krajina'nın merkezi, Trebinje bağlar ile Akdeniz etkili güney, Una Milli Parkı ise ülkenin kuzeybatısındaki büyük şelale ve nehir rotasıdır.",
    intro: ["İlk yolculukta Saraybosna'ya dört-beş, Mostar'a üç gece ayırın; güzel manzaralı tren seferi varsa gün ışığında kullanın. Blagaj'ı Mostar çevresinde en az bir tam gün, Travnik–Jajce'yi iki ayrı geceyle ekleyin.", "Banja Luka ve Una kuzeybatıda; Trebinje güneydoğudadır. Üçünü kısa Saraybosna–Mostar hattına sıkıştırmayın. Ülke içi tren ağı sınırlıdır; otobüs terminalinin şehirdeki yerini ve hangi idari ağda olduğunu biletten doğrulayın."],
    essentials: [
      { title: "Türk vatandaşları 90 güne kadar vizeden muaftır", body: "T.C. Dışişleri'nin güncel tablosuna göre umuma mahsus ve resmî Türk pasaportları 180 gün içinde 90 güne kadar vizeden muaftır. Pasaport, dönüş, konaklama ve sınır görevlisinin isteyebileceği belgeleri güncel resmî kaynaktan teyit edin." },
      { title: "Dönüştürülebilir mark ve nakit gerekir", body: "Resmî para KM/BAM'dir. Kart büyük işletmelerde yaygın; küçük lokanta, otobüs, pazar ve kırsalda nakit gerekir. Avro kabulüne güvenmeyin, banka ATM'si kullanın ve BAM seçin." },
      { title: "Otobüs terminallerini ve bileti ayırın", body: "Saraybosna ve Mostar çevresinde birden fazla terminal/işletme olabilir; çevrimiçi rota sonucu bilet değildir. İstasyon, bagaj ücreti, sınır geçişi ve son dönüşü taşıyıcıdan doğrulayın." },
      { title: "Mayın uyarısından asla sapmayın", body: "Kırsal ve eski çatışma bölgelerinde yalnız işaretli yol/patika kullanın; şüpheli cisme dokunmayın. Doğa turunda lisanslı yerel rehber ve faaliyet kapsamlı sigorta tercih edin." },
      { title: "Savaş hafızasını saygıyla okuyun", body: "Kuşatma, katliam, mezarlık ve yıkım alanlarını selfie dekoruna çevirmeyin. Toplulukları tek kimliğe indirgemeyen dil kullanın; siyasi gösteri ve provokatif sembollerden uzak durun." },
    ],
    routeIdeas: [
      { title: "Klasik Bosna-Hersek", duration: "8–11 gün", cities: ["Saraybosna", "Mostar", "Blagaj"], description: "Başkent dört-beş, Mostar üç, Blagaj bir tam gün; tren/otobüsü gün ışığında planlayın." },
      { title: "Orta Bosna tarihi", duration: "5–7 gün", cities: ["Travnik", "Jajce"], description: "Her kasabada iki gece; Vlašić veya Pliva Gölleri'nden yalnız bir ek doğa günü." },
      { title: "Krajina ve Una", duration: "7–10 gün", cities: ["Banja Luka", "Una Milli Parkı"], description: "Banja Luka üç, Bihać/park dört-beş gece; uzun kara bağlantısını hafife almayın." },
      { title: "Güney Hersek", duration: "4–6 gün", cities: ["Trebinje"], description: "Eski şehir, bağ, manastır ve mağara için yavaş üs; Dubrovnik sınırı ayrı Schengen işlemidir." },
    ],
  },
  AL: {
    seoTitle: "Arnavutluk Gezi Rehberi: 8 Durak, Alpler ve Riviera Rotaları",
    seoDescription: "Arnavutluk gezi rehberi: Tiran, Berat, Gjirokastër, Shkodër, Krujë, Theth, Sarandë ve Himarë için vize, ulaşım ve rota planı.",
    planningHeading: "Arnavutluk rotası nasıl kurulur?", essentialsHeading: "Arnavutluk'a gitmeden önce bilinmesi gerekenler", citiesHeading: "Arnavutluk'ta gezilecek şehirler ve doğa rotaları",
    cityGridIntro: "Arnavutluk'ta gezilecek yerler başkentten iki farklı coğrafyaya açılır. Tiran ve Krujë merkez tarihini; Berat ile Gjirokastër UNESCO taş kentlerini anlatır. Shkodër kuzey kültürü ile Theth'in Arnavut Alpleri'ne kapıdır. Sarandë, Butrint ve Ksamil için güney üssü; Himarë ise koyları, taş köyleri ve İyon kıyısında daha yavaş yolculuğu temsil eder.",
    intro: ["İlk kültür rotasında Tiran'a üç, Berat'a iki, Gjirokastër'e iki-üç gece ayırın; güneyde Sarandë veya Himarë'den birinde dört gece kurun. Kıyı yolu virajlı ve yazın yoğundur; harita mesafesini gerçek süre sanmayın.", "Kuzeyde Shkodër'e iki gece, Theth'e üç-dört gece ayırın. Valbona geçişi sıradan günübirlik değildir; hava, bagaj, karşı konaklama ve feribot/minibüs bağlantılarını birlikte kurun. Kuzey ile güneyi bir haftaya sıkıştırmayın."],
    essentials: [
      { title: "Türk vatandaşları 90 güne kadar vizeden muaftır", body: "T.C. Dışişleri'ne göre Türk vatandaşları 180 gün içinde 90 güne kadar Arnavutluk vizesinden muaftır. Sınır kontrolleri ayrıntılı olabilir; pasaport, dönüş bileti, konaklama ve seyahat amacını destekleyen belgeleri taşıyın." },
      { title: "Lek kullanın ve nakit yedek taşıyın", body: "Arnavut leki resmî paradır. Otel ve şehir restoranında kart bulunsa da minibüs, pazar, konukevi ve plajda nakit gerekir. Fiyatın lek mi avro mu olduğunu sorun; banka ATM'sinde ALL seçin." },
      { title: "Furgon saatini sabit tarife sanmayın", body: "Şehirler arası minibüsler doluluk ve trafikle değişebilir. Kalkış terminalini, son seferi ve bagajı aynı gün işletmeden doğrulayın; dağ/kıyı transferini uluslararası uçuşa sıkı bağlamayın." },
      { title: "Trafik ve araç sigortasını ciddiye alın", body: "Şehir yaya geçidi, virajlı Riviera yolu ve dağ bağlantıları dikkat ister. Kiralık araçta sınır geçiş izni, sigorta, park ve yol yardımını yazılı alın; karanlıkta dağ sürüşünü azaltın." },
      { title: "Dağ, kıyı ve arkeolojide koruma kuralı geçerlidir", body: "Theth'te işaretli patika ve hava, denizde cankurtaran bayrağı, Butrint'te resmî park rotası belirleyicidir. İzinsiz kamp/ateş, bariyer aşma ve lisanssız tekne turundan kaçının." },
    ],
    routeIdeas: [
      { title: "İlk Arnavutluk kültür rotası", duration: "8–11 gün", cities: ["Tiran", "Krujë", "Berat", "Gjirokastër"], description: "Tiran üç, Berat ve Gjirokastër ikişer gece; Krujë'yi Tiran'dan tam gün veya bir gece." },
      { title: "Arnavut Alpleri", duration: "7–10 gün", cities: ["Shkodër", "Theth"], description: "Shkodër iki, Theth dört gece; Valbona eklenirse bagaj, feribot ve iki yedek gün." },
      { title: "Güney İyon kıyısı", duration: "8–11 gün", cities: ["Sarandë", "Himarë"], description: "Her üsse üç-dört gece; Butrint, Gjipe ve taş köyleri ayrı günlere bölün." },
      { title: "Kültür ve kıyı dengesi", duration: "10–13 gün", cities: ["Berat", "Gjirokastër", "Himarë"], description: "İç bölgede iki tarih üssü, sonra denizde dört gece; virajlı karayoluna tam transfer günü." },
    ],
  },
  GR: {
    seoTitle: "Yunanistan Gezi Rehberi: 8 Rota, Adalar ve Antik Kentler",
    seoDescription: "Yunanistan gezi rehberi: Atina, Selanik, Santorini, Mikonos, Girit, Rodos, Korfu ve Meteora için Schengen, feribot ve rota planı.",
    planningHeading: "Yunanistan rotası nasıl kurulur?", essentialsHeading: "Yunanistan'a gitmeden önce bilinmesi gerekenler", citiesHeading: "Yunanistan'da gezilecek şehirler, adalar ve tarih rotaları",
    cityGridIntro: "Yunanistan'da gezilecek yerler tek bir ada tatilinden çok daha geniştir. Atina klasik miras ve mahalle yaşamını, Selanik Roma–Bizans–Osmanlı katmanlarını açar. Santorini ile Mikonos farklı Kiklad deneyimleri; Girit kendi başına uzun bir ada rotasıdır. Rodos Orta Çağ surları, Korfu İyon ve Venedik mirası, Meteora ise ana karada yaşayan manastırlar ile dağ peyzajını birleştirir.",
    intro: ["İlk gezide Atina'ya dört-beş gece ayırın ve yalnız bir ada kümesi seçin. Santorini–Mikonos mevsimsel feribotla bağlanabilir; Girit, Rodos ve Korfu ise birbirinden uzak ayrı uçuş/feribot ayaklarıdır.", "Kuzey rotasında Selanik'e üç-dört gece, Meteora'ya iki-üç gece ayırın. Atina–Selanik trenini ve Kalambaka bağlantısını güncel Hellenic Train duyurusundan kontrol edin; grev ve sefer değişikliği için yedek bırakın."],
    essentials: [
      { title: "Bordo pasaporta Schengen vizesi gerekir", body: "Yunanistan Dışişleri'nin ülke tablosunda umuma mahsus Türk pasaportu vizeye tabidir; hususi, hizmet ve diplomatik pasaportlar için muafiyet uygulanır. Başvuruyu Yunanistan ana destinasyon olduğunda yalnız resmî temsilcilik ve yetkili dış hizmet sağlayıcısından yapın." },
      { title: "Feribot bileti rota planının merkezidir", body: "Pire, Rafina, Lavrio ve ada limanları birbirinin yerine geçmez. Gemi, liman, check-in, bagaj ve araç yerini doğrulayın. Meltem rüzgârı, grev veya teknik durum seferi değiştirebilir; uçuşa ara gece bırakın." },
      { title: "Avro kullanılır; ada nakit yedeği ister", body: "Kart yaygındır ancak küçük ada, aile tavernası, plaj ve otobüste nakit gerekebilir. ATM'de avro seçin; ekmek/kuver, balık kilo fiyatı, şezlong ve servis ücretini siparişten önce sorun." },
      { title: "Arkeoloji ve ibadet alanını aynı kuralla değerlendirmeyin", body: "Müze ve ören yeri saatli bilet/kapanışa; manastır ve kilise kıyafet, ibadet ve fotoğraf kurallarına tabidir. Yaz sıcağında alanlar geçici kapanabilir; resmî duyuruya uyun." },
      { title: "Ada aracında deneyim ve sigorta önemlidir", body: "Scooter/ATV, dar yol ve rüzgâr ciddi kaza riski taşır. Ehliyet, kask ve sigorta kapsamını yazılı doğrulayın; deneyimsizseniz otobüs/taksi kullanın. Tekne turunda lisans ve can yeleği arayın." },
    ],
    routeIdeas: [
      { title: "İlk Yunanistan yolculuğu", duration: "8–11 gün", cities: ["Atina", "Meteora"], description: "Atina dört-beş, Meteora iki-üç gece; Delphi veya Sounion'dan yalnız birini ekleyin." },
      { title: "Kuzey Yunanistan", duration: "6–9 gün", cities: ["Selanik", "Meteora"], description: "Selanik dört, Kalambaka/Kastraki üç gece; Vergina'yı ayrı tam gün planlayın." },
      { title: "Kiklad adaları", duration: "8–11 gün", cities: ["Santorini", "Mikonos"], description: "Her adaya üç-dört gece, arada mevsimsel feribot ve bir hava yedeği." },
      { title: "Tek büyük ada", duration: "7–12 gün", cities: ["Girit", "Rodos", "Korfu"], description: "Üçünden yalnız birini seçin. Girit iki üs; Rodos veya Korfu bir şehir ve bir kıyı üssüyle planlanır." },
    ],
  },
  HR: {
    seoTitle: "Hırvatistan Gezi Rehberi: 8 Durak, Adalar ve Milli Parklar",
    seoDescription: "Hırvatistan gezi rehberi: Zagreb, Dubrovnik, Split, Zadar, Hvar, Istria, Plitvice ve Šibenik için Schengen, feribot ve rota planı.",
    planningHeading: "Hırvatistan rotası nasıl kurulur?", essentialsHeading: "Hırvatistan'a gitmeden önce bilinmesi gerekenler", citiesHeading: "Hırvatistan'da gezilecek şehirler, adalar ve milli parklar",
    cityGridIntro: "Hırvatistan'da gezilecek yerler kuzeyde Zagreb'in Orta Avrupa kültüründen güneyde Dubrovnik'in Ragusa surlarına uzanır. Split yaşayan Roma sarayı ve ada bağlantıları, Zadar gün batımı sanatı, Šibenik taş katedral ile Krka kapısıdır. Hvar uzun bir ada rotası, Istria çok merkezli gastronomi yarımadası, Plitvice ise saatli ve koruma kurallı büyük şelale parkıdır.",
    intro: ["İlk rota için Zagreb'e üç, Plitvice çevresine iki, Split'e dört ve Dubrovnik'e üç gece ayırın. Kıyı otobüsü veya araç mesafeleri yaz trafiğiyle uzar; Plitvice'yi şehirler arası transfer gününe sıkıştırmayın.", "Zadar–Šibenik–Split kuzey/orta Dalmaçya hattıdır. Hvar için en az üç-dört gece ayırın; Istria ise Rovinj/Pula ve iç köyler için başlı başına bir haftadır. Adaları sürekli tek gecelik valiz değişimine çevirmeyin."],
    essentials: [
      { title: "Bordo pasaporta Schengen vizesi gerekir", body: "Hırvatistan Dışişleri, umuma mahsus Türk pasaportunu vizeye tabi gösterir; hususi ve resmî pasaportlar için kısa kalış muafiyeti bulunabilir. Başvuruyu ana destinasyon kuralıyla yalnız resmî temsilcilik veya yetkili VFS kanalından yürütün." },
      { title: "Kıyıda otobüs ve feribot trenden önemlidir", body: "Zagreb ve bazı ana kara hatlarında HŽPP yararlıdır; Dalmaçya ve adalarda otobüs/feribot ana omurgadır. Liman, katamaran mı araç feribotu mu olduğu, rezervasyon ve son bağlantıyı ayrı doğrulayın." },
      { title: "Avro ve toplam turistik ücret", body: "Kart yaygın olsa da ada, pazar ve küçük işletmede nakit gerekir. Şehir vergisi, otopark, plaj seti, tekne, park bileti ve bagajı görünen oda/otobüs fiyatına ekleyin; ATM'de avroyu seçin." },
      { title: "Milli park bileti doğru girişe bağlıdır", body: "Plitvice, Krka, Kornati ve Paklenica ayrı sistemlerdir. Saat, giriş kapısı, tekne/shuttle, yüzme ve rota kapanışını parkın resmî sitesinden kontrol edin; bariyer dışına çıkmayın." },
      { title: "Yangın ve kıyı güvenliği günlük planı değiştirebilir", body: "Yaz sıcaklığı, rüzgâr ve yangın yol, ada veya orman rotasını kapatabilir. Açık ateş yakmayın; tekne/yüzmede hava ve bayrak uyarısına, eski çatışma alanlarında işaretli yola uyun." },
    ],
    routeIdeas: [
      { title: "Klasik Hırvatistan", duration: "12–15 gün", cities: ["Zagreb", "Plitvice Gölleri", "Split", "Dubrovnik"], description: "Başkent üç, park iki, Split dört, Dubrovnik üç gece; uzun kıyı transferine tam gün." },
      { title: "Kuzey Dalmaçya", duration: "7–10 gün", cities: ["Zadar", "Šibenik"], description: "Her şehirde üç gece; Kornati, Krka veya Paklenica'dan yalnız ikisini seçin." },
      { title: "Split ve ada", duration: "8–11 gün", cities: ["Split", "Hvar"], description: "Split dört, Hvar dört gece; doğru liman ve mevsimsel katamaranı erkenden sabitleyin." },
      { title: "Istria yavaş rotası", duration: "7–10 gün", cities: ["Istria"], description: "Rovinj/Pula kıyı üssü ve iç tepe köyleri; tadım sonrası araç kullanmadan iki merkezli program." },
    ],
  },
  SI: {
    seoTitle: "Slovenya Gezi Rehberi: 8 Durak, Alpler ve Karst Rotaları",
    seoDescription: "Slovenya gezi rehberi: Ljubljana, Bled, Bohinj, Piran, Postojna–Predjama, Soča, Maribor ve Kranjska Gora için Schengen ve rotalar.",
    planningHeading: "Slovenya rotası nasıl kurulur?", essentialsHeading: "Slovenya'ya gitmeden önce bilinmesi gerekenler", citiesHeading: "Slovenya'da gezilecek şehirler ve doğa rotaları",
    cityGridIntro: "Slovenya'da gezilecek yerler kompakt haritada dört coğrafyaya dağılır. Ljubljana nehir ve Plečnik başkenti; Bled simgesel göl, Bohinj Triglav'ın ciddi doğa üssüdür. Piran kısa Adriyatik kıyısını, Postojna–Predjama Karst yeraltını açar. Soča turkuaz nehir ve savaş hafızası, Maribor doğu bağları, Kranjska Gora ise Vršič–Planica ekseninde yüksek Alp rotasıdır.",
    intro: ["İlk yolculukta Ljubljana'ya üç gece, Bled'e iki, Bohinj'e üç gece ayırın. Bled günübirlik mümkün olsa da Bohinj'i aynı acele güne sıkıştırmayın; park shuttle'ı ve son otobüsü güncel kaynaktan kontrol edin.", "Karst ve kıyı hattında Postojna–Predjama'ya iki, Piran'a iki-üç gece ayırın. Soča Vadisi ile Kranjska Gora dağların iki tarafındadır; Vršič Geçidi mevsimsel ve hava bağımlıdır. Maribor doğuda ayrı tren ayağıdır."],
    essentials: [
      { title: "Bordo pasaporta Schengen C vizesi gerekir", body: "Slovenya'nın Ankara Büyükelçiliği umuma mahsus Türk pasaportuna kısa ziyaret için C tipi vize gerektiğini; diplomatik, hususi ve hizmet pasaportlarına 90 güne kadar muafiyet uygulandığını belirtir. Yalnız resmî ve yetkili başvuru kanalını kullanın." },
      { title: "Tren güçlüdür ama son kilometreyi çözmez", body: "Slovenske železnice Ljubljana–Maribor ve bazı bölgesel hatlarda yararlıdır; Bled, Bohinj, Soča ve dağ başlarında otobüs/shuttle gerekir. İstasyon adını, son bağlantıyı ve bisiklet taşıma kuralını kontrol edin." },
      { title: "Avro kullanılır; şehir vergisini ekleyin", body: "Kart yaygın olsa da dağ kulübesi, pazar ve küçük kırsal işletmede nakit yararlıdır. Konaklama vergisi, mağara, teleferik, göl teknesi, shuttle ve otoparkı ayrı hesaplayın." },
      { title: "Triglav bir park, dağ eğlence alanı değil", body: "İşaretli patika, kamp/ateş, drone, bitki ve yaban hayatı kurallarına uyun. Yüksek rota için hava, ekipman, kulübe, kurtarma sigortası ve gerektiğinde lisanslı rehber planlayın." },
      { title: "Mağara ile kanyon koşulları farklıdır", body: "Postojna/Škocjan serin, basamaklı ve saatli turdur; Soča/Vintgar su seviyesi ve mevsimsel kapanışa bağlıdır. Eski blog saatine değil resmî işletmenin günlük duyurusuna uyun." },
    ],
    routeIdeas: [
      { title: "İlk Slovenya yolculuğu", duration: "8–11 gün", cities: ["Ljubljana", "Bled Gölü", "Bohinj"], description: "Başkent üç, Bled iki, Bohinj üç-dört gece; göl ve dağ günlerine hava yedeği." },
      { title: "Karst ve Adriyatik", duration: "6–8 gün", cities: ["Postojna ve Predjama", "Piran"], description: "Mağara/kale iki, kıyı üç gece; Škocjan veya Lipica'dan yalnız birini ekleyin." },
      { title: "Julian Alpleri", duration: "9–12 gün", cities: ["Kranjska Gora", "Soča Vadisi"], description: "Her üste dört-beş gece; Vršič kapalıysa demiryolu/otobüs alternatifini kullanın." },
      { title: "Doğu Slovenya", duration: "4–6 gün", cities: ["Maribor"], description: "Maribor üç gece; Ptuj veya Jeruzalem bağlarından birini ayrı gün seçin." },
    ],
  },
  NO: {
    seoTitle: "Norveç Gezi Rehberi: 8 Durak, Fiyortlar ve Kuzey Işıkları",
    seoDescription: "Norveç gezi rehberi: Oslo, Bergen, Tromsø, Lofoten, Geirangerfjord, Flåm, Trondheim ve Stavanger için Schengen, ulaşım ve rota planı.",
    planningHeading: "Norveç rotası nasıl kurulur?", essentialsHeading: "Norveç'e gitmeden önce bilinmesi gerekenler", citiesHeading: "Norveç'te gezilecek şehirler, fiyortlar ve Arktik rotalar",
    cityGridIntro: "Norveç'te gezilecek yerler tek bir fiyort turundan çok daha geniştir. Oslo çağdaş müzeleri ve orman ulaşımını; Bergen yağmurlu liman ile batı fiyortlarını açar. Flåm demiryolu–Nærøyfjord kavşağı, Geirangerfjord yüksek seyir yolları, Stavanger Lysefjord yürüyüşleriyle öne çıkar. Trondheim Orta Norveç tarihini; Tromsø ve Lofoten ise birbirinden farklı Arktik şehir ve takımada deneyimlerini sunar.",
    intro: ["İlk yolculukta Oslo'ya üç-dört, Bergen'e üç gece ayırın; aradaki Bergen Demiryolu ile Flåm bağlantısını yalnız bilet değil aktarma ve bagaj zinciri olarak planlayın. Nærøyfjord turuna bir gece yedek eklemek rota baskısını azaltır.", "Geirangerfjord ile Stavanger aynı kısa fiyort çevrimi değildir. Tromsø ve Lofoten ise Oslo'dan ayrı uçuş/gece treni ayaklarıdır; kuzey ışığı için en az dört-beş gece ve hava yedeği bırakın. Haritadaki kıyı mesafesini düz karayolu sanmayın."],
    essentials: [
      { title: "Bordo pasaporta Schengen ziyaretçi vizesi gerekir", body: "Norveç Göçmenlik Müdürlüğü, umuma mahsus Türk pasaportuyla 90 güne kadar turistik ziyaret için vize gerektiğini belirtir; özel pasaport veya oturum temelli istisnayı kişisel belgeniz üzerinden kontrol edin. Başvuruyu Norveç ana destinasyon olduğunda resmî kanaldan yapın." },
      { title: "Entur planlar; işletmeci bileti yine önemlidir", body: "Entur tren, otobüs ve feribot seçeneklerini birlikte gösterir ancak koltuk, araç yeri veya fiyort teknesi ayrı rezervasyon isteyebilir. Aynı bilette olmayan aktarmalara geniş pay bırakın; son feribot ve kış yolunu aynı gün doğrulayın." },
      { title: "Norveç kronu ve yüksek toplam maliyet", body: "Kart çok yaygındır; terminalde NOK seçin. Konaklama, tren, iç hat, araç, köprü/feribot, bagaj ve doğa turunu ayrı hesaplayın. Market öğünü bütçeyi dengeler; eski bloglardaki günlük rakamları güncel fiyat sanmayın." },
      { title: "Fiyort ve dağ hava koşuludur", body: "Teleferik, seyir yolu, tekne ve patika rüzgâr, sis, kar, çığ, heyelan veya bakım nedeniyle kapanabilir. Resmî yol/park/işletmeci duyurusuna uyun; bariyer ve kapanışı fotoğraf için aşmayın." },
      { title: "Doğaya erişim sınırsız kamp değildir", body: "Allemannsretten doğada sorumlu dolaşım hakkıdır; özel bahçe, ekili alan, koruma bölgesi, park cebi veya ateş yasağını geçersiz kılmaz. Çöpünüzü taşıyın, tuvalet ve drone kuralını kontrol edin; yaban hayatına mesafe bırakın." },
    ],
    routeIdeas: [
      { title: "İlk Norveç yolculuğu", duration: "8–11 gün", cities: ["Oslo", "Flåm", "Bergen"], description: "Oslo üç-dört, Flåm/Aurland iki, Bergen üç gece; tren ve Nærøyfjord bağlantısına hava payı." },
      { title: "Batı fiyortları", duration: "9–12 gün", cities: ["Bergen", "Geirangerfjord", "Stavanger"], description: "Üç ayrı üs ve iki uzun transfer günü; tek seyahatte her fiyordu işaretlemek yerine iki ana su/dağ deneyimi seçin." },
      { title: "Orta Norveç kültür hattı", duration: "6–8 gün", cities: ["Oslo", "Trondheim"], description: "Gece/gündüz treniyle iki şehir; Røros veya kıyı rotasından yalnız birini ekleyin." },
      { title: "Arktik kuzey", duration: "9–13 gün", cities: ["Tromsø", "Lofoten"], description: "Tromsø dört-beş, Lofoten beş-yedi gece; araç/otobüs, hava ve iki ayrı ulaşım yedeği." },
    ],
  },
  SE: {
    seoTitle: "İsveç Gezi Rehberi: 8 Durak, Takımadalar ve Lapland",
    seoDescription: "İsveç gezi rehberi: Stockholm, Göteborg, Malmö, Uppsala, Gotland, Kiruna, Abisko ve Dalarna için Schengen, tren ve rota planı.",
    planningHeading: "İsveç rotası nasıl kurulur?", essentialsHeading: "İsveç'e gitmeden önce bilinmesi gerekenler", citiesHeading: "İsveç'te gezilecek şehirler, adalar ve kuzey rotaları",
    cityGridIntro: "İsveç'te gezilecek yerler Stockholm'ün ada müzelerinden Göteborg'un araçsız takımadalarına, Malmö'nün Öresund yaşamından Uppsala'nın akademik tarihine uzanır. Gotland Baltık'ta Orta Çağ ve kırsal ada rotası; Dalarna göl ve halk kültürü bölgesidir. Kiruna taşınan Arktik şehri, Abisko ise Kungsleden ve milli park kurallarıyla ayrı bir doğa üssüdür.",
    intro: ["İlk yolculukta Stockholm'e dört-beş, Göteborg'a üç gece ayırın; aradaki hızlı tren gününü erken sabitleyin. Uppsala başkentten kolay gün olsa da katedral, üniversite ve Gamla Uppsala için tam gün ister.", "Malmö güneyde Kopenhag/Lund eksenine; Gotland feribot veya uçuşla Baltık'a; Dalarna iç bölge trenine bağlanır. Kiruna–Abisko gece treni/uçuşlu kuzey ayağıdır ve kış gecikmesi için ayrı yedek gerekir."],
    essentials: [
      { title: "Bordo pasaporta Schengen vizesi gerekir", body: "İsveç Hükümetinin listesinde umuma mahsus Türk pasaportu vizeye tabidir; diplomatik, hizmet ve hususi pasaportlarda kısa ziyaret muafiyeti olabilir. İsveç ana destinasyon olduğunda yalnız resmî temsilcilik ve yetkili başvuru kanalını kullanın." },
      { title: "SJ tek tren işletmecisi değildir", body: "SJ uzun mesafede ana kaynaklardan biridir; bölgesel ve özel işletmeciler, gece treni, Gotland feribotu ve takımada tekneleri ayrı bilet düzeni kullanabilir. Doğru istasyon, operatör, koltuk ve bisiklet/valiz şartını kontrol edin." },
      { title: "İsveç kronu ve nakitsiz yaşam", body: "Kart/mobil ödeme çok yaygındır ve bazı işletmeler nakit kabul etmez. Yedek fiziksel kart taşıyın, terminalde SEK seçin; toplu taşıma biletini araca binmeden alın. Bahşiş zorunlu değildir." },
      { title: "Arktik rota mevsim ve güvenlik ister", body: "Kiruna–Abisko'da kısa gün, aşırı soğuk, çığ, kar ve zayıf telefon kapsaması planı belirler. Kuzey ışığı garanti değildir; resmî park ve hava duyurusuna uyun, kış doğasına rehbersiz hazırlıksız çıkmayın." },
      { title: "Sámi kültürünü yaşayan bağlamıyla gezin", body: "İsveç Laponyası Sápmi'nin parçasıdır. Yerli topluluk tarafından işletilen deneyimleri tercih edin; kıyafet, joik, ren geyiği ve törenleri dekor gibi kullanmayın. İnsan ve özel alan fotoğrafında açık rıza alın." },
    ],
    routeIdeas: [
      { title: "Klasik İsveç", duration: "8–11 gün", cities: ["Stockholm", "Uppsala", "Göteborg"], description: "Stockholm dört-beş, Uppsala bir-iki, Göteborg üç gece; takımada için ayrı gün." },
      { title: "Öresund ve batı kıyısı", duration: "6–9 gün", cities: ["Malmö", "Göteborg"], description: "Malmö/Lund üç, Göteborg dört gece; Kopenhag eklenirse pasaport ve uluslararası tren planı." },
      { title: "Baltık ve iç bölge", duration: "8–11 gün", cities: ["Gotland", "Dalarna"], description: "İki bağımsız bölge ayağı; feribot/uçuş ve Stockholm aktarmasına bir tam gün." },
      { title: "İsveç Laponyası", duration: "7–10 gün", cities: ["Kiruna", "Abisko"], description: "Kiruna üç, Abisko dört-beş gece; kış/gece treni ve hava için en az bir yedek gün." },
    ],
  },
  DK: {
    seoTitle: "Danimarka Gezi Rehberi: 8 Şehir, Adalar ve Viking Rotaları",
    seoDescription: "Danimarka gezi rehberi: Kopenhag, Aarhus, Odense, Aalborg, Ribe, Skagen, Bornholm ve Roskilde için Schengen, tren ve rota planı.",
    planningHeading: "Danimarka rotası nasıl kurulur?", essentialsHeading: "Danimarka'ya gitmeden önce bilinmesi gerekenler", citiesHeading: "Danimarka'da gezilecek şehirler, adalar ve kıyı rotaları",
    cityGridIntro: "Danimarka'da gezilecek yerler Kopenhag'ın saray ve tasarım ekseninden Aarhus'un büyük müzelerine, Odense'nin Andersen mirasından Aalborg'un Limfjord kıyısına uzanır. Roskilde Viking gemileri ve kraliyet katedrali; Ribe Wadden Denizi ve Orta Çağ dokusu, Skagen iki deniz ve sanatçılar, Bornholm ise başlı başına bisikletli Baltık adası rotasıdır.",
    intro: ["İlk gezide Kopenhag'a dört-beş, Aarhus'a üç gece ayırın; Roskilde'yi başkentten tam gün, Odense'yi iki gecelik Funen ayağı olarak ekleyin. Tren hızlı olsa da müze ve mahalle zamanını transfer günüyle eritmeyin.", "Jutland kuzeyi için Aalborg–Skagen; batı/güney için Ribe–Wadden Sea ayrı kümelerdir. Bornholm Kopenhag kartının uzantısı değil; Ystad üzerinden sınır geçişli feribot veya uçuşla en az dört gece isteyen ada rotasıdır."],
    essentials: [
      { title: "Bordo pasaporta Schengen vizesi gerekir", body: "Danimarka Dışişleri, umuma mahsus Türk pasaportunun vizeye tabi; diplomatik, hizmet ve hususi pasaportların kısa kalışta muaf olabildiğini belirtir. Danimarka ana destinasyon olduğunda resmî temsilcilik/VFS kanalını kullanın; Faroe ve Grönland için ayrı geçerlilik gerekebilir." },
      { title: "DSB ve doğru zon/bilet", body: "DSB tren omurgasını sağlar; metro, S-tren, otobüs, liman otobüsü ve bölgesel işletmeciler farklı zon/ürün kullanabilir. Bileti araca binmeden alın, bisiklet ve yoğun saat kuralını kontrol edin; Bornholm feribotunu ayrıca rezerve edin." },
      { title: "Danimarka kronu kullanılır", body: "Kart ve temassız ödeme yaygındır; bazı küçük işletmeler yabancı karta ek ücret veya yerel mobil ödeme kısıtı uygulayabilir. Terminalde DKK seçin ve yedek kart taşıyın. Servis çoğunlukla fiyata dahildir; bahşiş zorunlu değildir." },
      { title: "Bisiklet kültürü trafik kuralıdır", body: "Bisiklet şeridinde yürümeyin. Kiralama öncesi el işareti, ışık, dönüş ve park kuralını öğrenin; deneyimsizseniz yoğun Kopenhag saatinde başlamayın. Kıyı rotasında rüzgâr, yağmur ve görünürlük ekipmanı taşıyın." },
      { title: "Kıyı ve gelgit hafife alınmaz", body: "Grenen'de yüzmek, Wadden Sea düzlüklerine rehbersiz çıkmak veya limanda izin dışı suya girmek tehlikelidir. Resmî bayrak, gelgit, akıntı ve hava duyurusuna uyun; küçük ada feribotuna dönüş payı bırakın." },
    ],
    routeIdeas: [
      { title: "İlk Danimarka yolculuğu", duration: "8–10 gün", cities: ["Kopenhag", "Roskilde", "Odense", "Aarhus"], description: "Kopenhag dört, Roskilde tam gün, Odense iki, Aarhus üç gece; trenle doğrusal rota." },
      { title: "Kuzey Jutland", duration: "5–7 gün", cities: ["Aalborg", "Skagen"], description: "Aalborg iki-üç, Skagen üç gece; Grenen ve sanat/kumul günlerini ayırın." },
      { title: "Tarih ve Wadden Denizi", duration: "4–6 gün", cities: ["Ribe"], description: "Ribe iki-üç gece; Mandø veya Esbjerg'den yalnız birini gelgit ve müze saatine göre ekleyin." },
      { title: "Bornholm ada rotası", duration: "5–7 gün", cities: ["Bornholm"], description: "Rønne ile kuzey/doğu kıyısında iki üs; bisiklet, feribot ve hava için esnek gün." },
    ],
  },
  FI: {
    seoTitle: "Finlandiya Gezi Rehberi: 8 Durak, Göller ve Lapland",
    seoDescription: "Finlandiya gezi rehberi: Helsinki, Rovaniemi, Turku, Tampere, Porvoo, Göller Bölgesi, Inari–Saariselkä ve Åland için rota planı.",
    planningHeading: "Finlandiya rotası nasıl kurulur?", essentialsHeading: "Finlandiya'ya gitmeden önce bilinmesi gerekenler", citiesHeading: "Finlandiya'da gezilecek şehirler, göller ve kuzey rotaları",
    cityGridIntro: "Finlandiya'da gezilecek yerler Helsinki'nin tasarım ve ada kültüründen Turku'nun Orta Çağ–takımada hattına, Tampere'nin sanayi ve saunalarından Porvoo'nun ahşap eski şehrine uzanır. Göller Bölgesi Savonlinna–Saimaa gibi çok merkezli doğa rotasıdır. Rovaniemi Lapland kapısı; Inari–Saariselkä Sámi kültürü ve tundra, Åland ise İsveççe konuşulan özerk Baltık takımadasıdır.",
    intro: ["İlk yolculukta Helsinki'ye dört, Turku veya Tampere'ye üç gece ayırın; Porvoo'yu sakin bir tam gün olarak ekleyin. Turku–Tampere doğrudan coğrafi halka gibi görünse de tren ve otobüs bağlantısını saat bazında kontrol edin.", "Rovaniemi'ye gece treni/uçuşla ayrı kuzey ayağı kurun. Inari–Saariselkä daha kuzeyde Ivalo bağlantılı ve en az beş gece isteyen iki merkezdir. Göller Bölgesi ile Åland da birbirinin alternatifi olan bağımsız yaz rotalarıdır."],
    essentials: [
      { title: "Bordo pasaporta Schengen vizesi gerekir", body: "Finlandiya'nın Türkiye temsilciliği, umuma mahsus Türk pasaportunun vizeye tabi; diplomatik, hizmet ve hususi pasaportların kısa ziyarette muaf olabildiğini belirtir. Finlandiya ana destinasyon olduğunda yalnız resmî ve yetkili başvuru kanalını kullanın." },
      { title: "VR gece treni kuzeyi bağlar", body: "VR güney şehirlerinden Rovaniemi/Kemijärvi yönüne tren ve yataklı gece treni işletir. Koltuk/yatak, araç taşıma, istasyon ve bagajı ayrı kontrol edin; kuzeyde son kilometre otobüs/transferini önceden sabitleyin." },
      { title: "Avro, kart ve görünmeyen kuzey maliyeti", body: "Kart yaygındır; küçük pazar/kır işletmesi için sınırlı nakit yedeği taşıyın. Lapland'da termal giysi, tur, transfer, bagaj ve iptal koşulu maliyeti büyütür. Cam kabin ya da aurora turu olmadan da dengeli rota kurulabilir." },
      { title: "Sauna görgüsü tesise göre değişir", body: "Mayo, havlu, karma/cinsiyete göre bölüm, sessizlik ve fotoğraf kuralını tesisten öğrenin. Alkollüyken sıcak sauna veya soğuk suya girmeyin; kalp/sağlık riski varsa profesyonel tavsiye alın." },
      { title: "Buz ve Arktik koşullar profesyonel karar ister", body: "Donmuş göl/nehir üzerine yalnız resmî güvenlik bilgisiyle çıkın. Kuzey ışığı garanti değildir; kış yolunda kar, ren geyiği, beyaz körlük ve zayıf kapsama için acil ekipman taşıyın. Sámi kültüründe yerli işletme ve fotoğraf rızasını önemseyin." },
    ],
    routeIdeas: [
      { title: "Güney Finlandiya", duration: "8–11 gün", cities: ["Helsinki", "Porvoo", "Turku"], description: "Helsinki dört, Porvoo bir-iki, Turku üç gece; Suomenlinna ve takımada için ayrı günler." },
      { title: "Şehir ve göller", duration: "9–12 gün", cities: ["Helsinki", "Tampere", "Finlandiya Göller Bölgesi"], description: "İki şehirden sonra Savonlinna/Saimaa ya da Kuopio/Koli kümelerinden yalnız birini seçin." },
      { title: "Lapland kültür ve doğa", duration: "9–13 gün", cities: ["Rovaniemi", "Inari ve Saariselkä"], description: "Rovaniemi dört, Inari–Saariselkä beş-yedi gece; Ivalo transferi ve iki hava yedeği." },
      { title: "Åland takımadası", duration: "5–8 gün", cities: ["Åland Adaları"], description: "Mariehamn ve kırsal/ara ada üsleri; bisiklet, küçük feribot ve rüzgâr için esnek program." },
    ],
  },
  SJ: {
